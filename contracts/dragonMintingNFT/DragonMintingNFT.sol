...
contract DragonMintingNFT is ERC721 {
    ...
    constructor(uint8 _maxLevel, uint32[] memory _xpToLevelUp) ERC721("Dragon Rearing","DR") {
    ...
    // 신규 드래곤 NFT 생성
    function mintNewDragon(address requester, uint256[] memory _randomWords) internal {
